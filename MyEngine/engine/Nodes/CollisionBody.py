...
class CollisionBody(TransformNode):
    def __init__(self, parent, children=[], name="CollisionBody",color=(100,100,100) ,x=0, y=0, active=True, width=0, height=0, collision_type="Rect"):
